...
A vibe coded Slack app that automatically captures team ideas to a shared canvas. Built with "vibe coding" using Claude Sonnet and the Slack Developer MCP Server.
